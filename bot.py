            ...
            if now >= next_trade_at:
                ...
                for market in market_list:
                    ...
                    try:
                        ...
                        p(f"BOOK ERROR | {market['asset']} | {market['slug']} | {type(exc).__name__}: {exc}")
                        continue
                ...
                if eligible:
                    ...
                    if band_candidates:
                        ...
                        if signal is not None:
                            ...
                            min_fill = float(os.getenv("MIN_PAPER_FILL_USD", "0.10"))
                            if notion >= min_fill and left > strategy.hard_cutoff_seconds:
                                ...
                                p(
                                    f"TRADE PAPER | V16.0 40PCT | asset={market['asset']} "
